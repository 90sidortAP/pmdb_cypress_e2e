...
export const templateSelTA = 'select[id="id_therapeutical_area"]'
export const templateSelPrio = 'select[id="id_priority"]'
export const templateSelATC = 'select[id="id_atc3_or_otc3"]'
